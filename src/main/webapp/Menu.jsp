...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            %>
            <li><a class="nav-link" href="#"><span clsass="glyphicon glyphicon-user"></span> Xin chào <%=session.getAttribute("dn")%></a></li>
            <li><a class="nav-link" href="logout.jsp"><span class="glyphicon glyphicon-log-out"></span> Đăng xuất</a></li>
            <%
            } else {
            %>
            <li><a class="nav-link" href="dangnhapcontroller"><span class="glyphicon glyphicon-log-in"></span> Đăng nhập</a></li>
    ...
    <tr>
        <td width="200" valign="top">
            <table class="table table-hover">
                ...
                %>
                <tr>
                    <td><a href="sachcontroller?ml=<%=l.getMaloai()%>"> <%=l.getMaloai()%></a></td>
                </tr>
                <%
                }
                %>
            ...
            <table class="table">
                ...
                <tr>
							<td>
								...
								<a href="dathangcontroller?ms=<%=s.getMasach()%>&ts=<%=s.getTensach()%>&gia=<%=s.getGia()%>&tg=<%=s.getTacgia()%>&anh=<%=s.getAnh()%>">
