		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="dathangcontroller"><span
						class="glyphicon glyphicon-shopping-cart"></span>Giỏ Hàng(<%=slg%>)
				</a></li>
				...
				<table class="table">
					...
					<tr>
						<td><a
							...
							<a
							href="dathangcontroller?ms=<%=s.getMasach()%>&ts=<%=s.getTensach()%>&gia=<%=s.getGia()%>&tg=<%=s.getTacgia()%>&anh=<%=s.getAnh()%>">
