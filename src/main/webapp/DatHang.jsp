				...
				%>
						...
						<h6>tong: =<%=gbo.Tongtien() %>></h6>
							<a href="ThanhToan.jsp" class="btn btn-success">Thanh Toán</a> <a
								href="sachcontroller" class="btn btn-primary">Tiếp Tục Mua Sắm</a>
						</div><%}%>
					</table>
					</form>
			</td>
